...
// 1. Define your project data (Images and their single line of text)
const slides = [
  {
    id: 1,
...
export default function ProjectCarousel() {
  ...
  // 2. Handle Automatic Loop (Changes image every 4 seconds)
  useEffect(() => {
  ...
  // 3. Handle Mobile Swipe Gestures
      ...
      <div className="absolute inset-0 w-full h-full z-0">
        <AnimatePresence mode="wait">
          <motion.div
            ...
            // Drag properties for mobile touch manipulation
            drag="x"
